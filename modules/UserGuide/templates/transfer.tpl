...
{if $havegz}
  <a id="export" class="ui-button ui-state-default ui-corner-all ui-button-text-icon-primary" href="{cms_action_url action=export type=gzip}" role="button">
    <span class="ui-button-icon ui-icon ui-icon-arrowreturnthick-1-s"></span> {$mod->Lang('export_archive')}
  </a>
{/if}
{if $havexml}
  <a id="export2" class="ui-button ui-state-default ui-corner-all ui-button-text-icon-primary" href="{cms_action_url action=export type=xml}" role="button">
...
<label id="selectorlabel" class="ui-button ui-corner-all" for="infile" role="button">
...
<div class="pageoverflow">
  ...
  <a id="importold" class="ui-button ui-state-default ui-corner-all ui-button-text-icon-primary" href="{cms_action_url action='import_module' source='UserGuide2'}" role="button">
...
<div class="pageoverflow">
  ...
  <a id="importvold" class="ui-button ui-state-default ui-corner-all ui-button-text-icon-primary" href="{cms_action_url action='import_module' source='UsersGuide'}" role="button">
    <span class="ui-button-icon ui-icon ui-icon-arrowreturnthick-1-n"></span> {$mod->Lang('import')}
  </a>
</div>
{/if}
