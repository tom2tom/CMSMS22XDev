...
/*
    function onSetupSpacer(api) {
      var nodeChanged = function() {
        api.setEnabled(editor.selection.isEditable()); // global editor, V6 method
      };
...
*/
    ...
    // add a menu item
    editor.ui.registry.addMenuItem('nonbreaking_CP', {
      icon: 'non-breaking',
...
//    onSetup: onSetupSpacer
    ...
    // and a button
    editor.ui.registry.addButton('nonbreaking_CP', {
      icon: 'non-breaking',
