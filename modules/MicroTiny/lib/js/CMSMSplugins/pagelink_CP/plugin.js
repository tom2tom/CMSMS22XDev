...
//      onCancel: function(dialogApi) {},
    ...
    function onLinkerSetup(api) {
      return function(api) {
        var updateState = function() {
//        stateSelector: 'a[href*="cms_selflink"]',//'implicit-url' anchors TODO V5 workaround needed
    ...
    // add a menu item
    editor.ui.registry.addMenuItem('pagelink_CP', {
      icon: 'pagelink',
      onAction: linker_showDialog,
      onSetup: onLinkerSetup,
      text: cmsms_tiny.linker_text + '...'
    });
    // and a button
    editor.ui.registry.addButton('pagelink_CP', {
      icon: 'pagelink',
      onAction: linker_showDialog,
      onSetup: onLinkerSetup,
