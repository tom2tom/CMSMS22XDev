...
{tab_start name='example' active=$tab}
  {form_start}
   {cms_textarea forcemodule='MicroTiny' name='mt_example' id='mt_example' enablewysiwyg=1 rows=10 columns=80 value=$demo}
