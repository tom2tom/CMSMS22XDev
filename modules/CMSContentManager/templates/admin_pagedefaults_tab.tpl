...
<div class="pageoverflow">
	...
	<p class="pageinput">		<textarea id="metadata" name="{$actionid}metadata" rows="5" cols="80">{$page_prefs.metadata|cms_escape}</textarea></p>
</div>
<div class="pageoverflow">
	...
	<p class="pageinput">		<textarea id="content" name="{$actionid}content" rows="5" cols="80">{$page_prefs.content|cms_escape}</textarea></p>
</div>
<div class="pageoverflow">
