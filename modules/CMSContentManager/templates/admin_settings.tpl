...
{tab_header name='global' label=$mod->Lang('prompt_global') active=$tab}
...
{tab_start name='global'}
{include file='module_file_tpl:CMSContentManager;admin_globalsettings_tab.tpl'}
{tab_end}
