...
{$startform}
<div class="pageoverflow">
  <p class="pagetext"><label for="angletxt">{$mod->Lang('angle')}:</label>
    <input type="text" id="angletxt" name="{$actionid}angle" style="border:0;pointer-events:none" size="4" value="0" readonly>
  </p>
  <div class="pageinput">{$mod->Lang('predefined')}:
    ...
    <button class="autorotate" id="pos0" title="{$mod->Lang('rotate_pos0')}">&nbsp;0&nbsp;</button>
  ...
  <p class="pageinput" id="rotangle" title="{$mod->Lang('info_rotate_slider')}"></p>
</div>
<div class="pageoverflow">
...
<div class="pageoverflow">
  ...
  <p class="pageinput">
    <select id="createthumb" name="{$actionid}createthumb">
      {cms_yesno selected=$createthumb}
    </select>
  </p>
</div>
<br>
