/*
 * jQuery File Upload Plugin v.10.32.0
 * https://github.com/blueimp/jQuery-File-Upload
 *
 * Copyright 2010-2021, Sebastian Tschan
 * https://blueimp.net
 *
...
(function (factory) {
  ...
  function getDragHandler(type) {
    ...
    return function (e) {
      ...
      if (
        dataTransfer &&
        $.inArray('Files', dataTransfer.types) !== -1 && //c.f. dataTransfer.types.indexOf('Files')
  ...
  $.widget('blueimp.fileupload', {
    ...
    _setOption: function (key, value) {
      var reinit = $.inArray(key, this._specialOptions) !== -1; //c.f. this._specialOptions.indexOf(key)
      if (reinit) {
        this._destroyEventHandlers();
      }
