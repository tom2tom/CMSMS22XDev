{$startform}
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      <p class="pageinput">
        <input type="checkbox" id="alert_drafts" name="{$actionid}alert_drafts" value="1"{if $alert_drafts} checked{/if}>
      </p>
    </div>
    <div class="pageoverflow">
    ...
    <div class="pageoverflow">
      ...
      <p class="pageinput">
        <input type="checkbox" id="fld3" name="{$actionid}hide_summary_field" value="1"{if $hide_summary_field==1} checked{/if}>
      </p>
    </div>
    <div class="pageoverflow">
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      <p class="pageinput">
        <input type="checkbox" id="fld9_a" name="{$actionid}allow_fesubmit" value="1"{if $allow_fesubmit} checked{/if}>
    ...
    <div class="pageoverflow">
      <p class="pagetext"><label for="selredirect_0">{$title_fesubmit_redirect}:</label> {cms_help key='help_fesubmit_redirect' title=$title_fesubmit_redirect}</p>
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      <p class="pagetext"><label for="selreturn_0">{$title_detail_returnid}:</label> {cms_help key='info_detail_returnid' title=$title_detail_returnid}</p>
