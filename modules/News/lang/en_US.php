...
$lang['help_articles_filtercategory'] = 'Optionally limit the articles displayed in this list to those that belong to the selected category';
$lang['help_articles_filterchildcats'] = 'If enabled, articles in the selected category or in its descendent-categories will be displayed.';
...
$lang['nextpage'] = '&gt;';
$lang['noarticles'] = 'There is currently no news article recorded';
$lang['noarticlesinfilter'] = 'There is no news article to show using the current filter';
...
$lang['prompt_allow_fesubmit'] = 'Allow news articles to be submitted via the frontend';
...
$lang['prompt_settings'] = 'Articles List Settings'; // dialog heading
...
$lang['title_filterapplied'] = 'The filter is probably excluding some articles from the display';
