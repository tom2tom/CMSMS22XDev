...
<table class="pagetable">
  ...
  {foreach $list_designs as $design}
    ...
    <tr class="{$rowclass}" onmouseover="this.className='{$rowclass}hover';" onmouseout="this.className='{$rowclass}';">
      ...
      <td>
      {if !$design->get_default()}{cms_action_url action=admin_delete_design design=$design->get_id() assign='delete_url'}
...
{else}
<p class="information">{$mod->Lang('warning_no_design')}</p>
{/if}
