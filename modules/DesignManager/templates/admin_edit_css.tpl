...
<div class="pageoverflow">
    ...
    {$all_types=explode(',','all,aural,speech,braille,embossed,handheld,print,projection,screen,tty,tv')}{*types aural,braille,embossed,handheld,projection,tty,tv are deprecated, maybe speech too*}
