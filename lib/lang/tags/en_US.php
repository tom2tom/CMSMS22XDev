...
<h3>How do I use it?</h3>
<p>Just insert the tag into your template/page like: <code>{current_date format="%A %d-%h-%y %T %Z"}</code></p>
<h3>What parameters does it take?</h3>
<ul>
...
<h3>How do I use it?</h3>
<p>Just insert the tag into your template/page like: <code>{modified_date format="%A %d-%h-%y %T %Z"}</code></p>
<h3>What parameters does it take?</h3>
<ul>
 <li><em>(optional)</em>format - Date/Time format using parameters from php's strftime function.  See <a href="http://php.net/strftime" target="_blank">here</a> for a parameter list and information.</li>
...
<h3>How do I use it?</h3>
<p>Just insert the tag into your template/page like: <code>{created_date format="%A %d-%h-%y %T %Z"}</code></p>
<h3>What parameters does it take?</h3>
<ul>
 <li><em>(optional)</em>format - Date/Time format using parameters from php's strftime function.  See <a href="http://php.net/strftime" target="_blank">here</a> for a parameter list and information.</li>
 <li><em>(optional)</em>assign - Assign the results to the named smarty variable.</li>
...
<h3>What does this do?</h3>
<p>This plugin allows you inject javascript libraries and plugins and related stylesheets.</p>
<h3>How do I use it?</h3>
...
<ul>
 ...
 <li><tt>json</tt></li>
 <li><tt>cms_admin</tt></li>
 <li><tt>cms_dirtyform</tt></li>
 <li><tt>cms_lock</tt></li>
 <li><tt>cms_hiersel</tt></li>
 <li><tt>cms_filepicker</tt></li>
 <li><tt>cms_autorefresh</tt></li>
 <li><tt>ui_touch_punch</tt></li>
</ul>
<h3>What parameters does it take?</h3>
<ul>
