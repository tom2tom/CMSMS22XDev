...
{
    if( get_class($smarty) == 'Smarty_Parser' ) return ''; // (Smarty_Parser deprecated, any construction exits request) if we are in the parser, we don't process module calls.
