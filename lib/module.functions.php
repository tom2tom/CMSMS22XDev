...
{
    if( get_class($smarty) == 'Smarty_Parser' ) return ''; // (deprecated Smarty_Parser triggers abort, should be UNUSED) if we are in the parser, we don't process module calls.
    ...
    if( isset($_REQUEST['mact']) ) { //OR $params[] ?
