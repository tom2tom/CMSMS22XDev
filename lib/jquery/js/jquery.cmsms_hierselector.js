...
//    secure_param and secure_value set in _create()
    },
    ...
    _create: function() {
      ...
      if (!this.options.secure_value) throw 'The secure_value option (string) must be set in the cmsms hierselector plugin';
      ...
      this.data.ajax_url = this.options.admin_url + '/ajax_content.php?' + this.options.secure_param + '=' + this.options.secure_value;
