<?php
#CMS Made Simple class ModuleOperations
...
<!DOCTYPE module [
  ...
  <!ELEMENT data (#PCDATA)>
     ...
     * @param bool $overwrite Should we overwrite files if they exist? Default false
        ...
        if( $dependents ) {
            ...
            if( is_array($deps) && count($deps) ) {
                foreach( $deps as $name => $ver ) {
                    ...
                    // this is the start of an indirect recursive process.
