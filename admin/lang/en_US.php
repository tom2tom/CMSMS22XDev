...
$lang['addthismark'] = "Bookmark This Page";
...
$lang['adminlogdescription'] = "This logs Admin activity and shows e.g. content changes, user information, and time of access.";
...
$lang['adminspecialgroup'] = "Note: members of this group automatically have all permissions";
...
$lang['admin_lock_timeout'] = "Lock Timeout <em>(minutes)</em>";
...
$lang['autoclearcache2'] = "Lifetime of Cached Files <em>(days)</em>";
...
$lang['cantremove'] = "Cannot Remove"; // ModuleManager only use?
...
$lang['checkversion'] = "New-Version Checks";
...
$lang['close'] = "Close";
$lang['CMSEX_C001'] = "Unable to create a valid page alias from the input supplied";
...
$lang['CMSEX_L010'] = "This item is locked, and cannot be edited (until the lock is released, or stolen after its expiry).";
...
$lang['config_writable'] = "config.php writeable. It is safer to change its permission to read-only";
...
$lang['confirm_switchuser'] = 'Are you sure you want to switch the effective UID to this user?  You will need to log out from the admin console and re-login to resume normal operations under your user account.';
...
$lang['contentimage_path'] = "Relative path for content images"; // 'content_imagefield_path' different use
$lang['contentmanagement'] = "Content Management";
$lang['contenttype'] = "Content Type"; // for ContentManager only ?
...
$lang['default_contenttype'] = "Default Content Type"; // for ContentManager only ?
...
$lang['enablesitedown'] = "Is the website &quot;Down for Maintenance&quot;";
...
//$lang['errorcssinuse'] = "This stylesheet is still used by template(s) or page(s). Please remove those associations first.";
$lang['errordefaultpage'] = "You cannot delete the default page. Please set a different default page then try again.";
...
$lang['errorgroupexists'] = "A group with this name already exists";
...
$lang['error_no_content_blocks'] = "No content block was detected in this template.  Please ensure that there is at least the default {content} block defined in this template.";
...
$lang['error_passwordrequired'] = "A <strong>password</strong> is required for SMTP authentication";
...
$lang['error_sitedownmessage'] = "It appears that this site's sitedown message is empty.  Please at least display some text to inform visitors that this site is down for maintenance.";
$lang['error_timedifference2'] = "A discrepancy in time with the PHP environment was detected. This may cause problems when publishing e.g. news articles.";
...
$lang['error_usernamerequired'] = "A <strong>username</strong> is required for SMTP authentication";
$lang['event'] = "Event";
...
$lang['frontendparameters'] = "Frontend-Action Parameters";
...
$lang['globalconfig'] = "Settings - Global";
$lang['globalmetadata'] = "Global Metadata";
$lang['global_umask'] = "File and Directory Creation Mask (umask)";
$lang['goto'] = "Back to:";
$lang['group'] = "Group";
...
$lang['help_content_image'] = "This field allows associating an image with the content page.  Such image might be for display on the page, or used when building a navigation, etc.  Enter or select an absolute url, or a site-root-relative url, or just a file basename which will be taken to indicate the file is located in or below the site's configured uploaded-images folder.  See also the 'content_imagefield_path' site-preference.";
...
$lang['hide_help_links'] = "Module Help Links";
...
$lang['help_title_content_default'] = 'Default toggle';
...
$lang['help_title_content_target'] = 'Target selector';
...
$lang['indent'] = "Indent pageslist to emphasize hierarchy";
...
$lang['info_changegroupperms'] = "This page allows specifying the permission(s) granted to admin-console user groups.  Keep in mind that each user can belong to multiple groups.<br><strong>Note:</strong> the &quot;Admin&quot; group is special, its members are granted <strong><em>all permissions</em></strong>.";
$lang['info_changeusergroup'] = "This page allows specifying the user group(s) to which each admin-console user belongs.  Group membership determines the permissions the user has, and therefore her/his capabilities in the admin console.<br><strong>Note:</strong> the &quot;Admin&quot; group is special, its members are granted <strong><em>all permissions</em></strong>.";
...
$lang['info_default_none'] = 'Currently there is no recorded default page';
$lang['info_default_page'] = 'The default page currently is: %s (%s)';
...
$lang['info_membergroups'] = "A user may be a member of zero or more groups.  A user who is not a member of any group will still be able to log in to the Admin Console";
...
$lang['info_settings_sitedown'] = "These options allow you to toggle the website as &quot;down for maintenance&quot; for website visitors.";
//$lang['info_setusersettings'] = "Set this user's settings to be a template for newly created users and to affect other users";
...
$lang['info_this_templateuser'] = "This account is set as the template user.  New accounts will inherit this user's settings, and you can copy this user's settings to any user account";
...
$lang['logintitle'] = "Log in to the %s website Administration Console";
...
$lang['maintenance_warning'] = "Website is still in maintenance mode! Are you sure you want to log out now?";
$lang['managebookmarks'] = "My Bookmarks";
$lang['managebookmarksdescription'] = "This is where you can manage your website-page shortcuts.";
...
$lang['mediatype_aural'] = "aural : Intended for speech synthesizers."; //deprecated type
$lang['mediatype_braille'] = "braille : Intended for Braille tactile feedback devices."; //deprecated type
$lang['mediatype_embossed'] = "embossed : Intended for paged Braille printers."; //deprecated type
...
$lang['mediatype_projection'] = "projection : Intended for projected presentations, for example projectors or print to transparencies."; //deprecated type
$lang['mediatype_screen'] = "screen : Intended primarily for color computer screens.";
$lang['mediatype_speech'] = "speech : Intended for speech synthesizers."; //maybe deprecated type
$lang['mediatype_tty'] = "tty : Intended for media using a fixed-pitch character grid, such as Teletypes and terminals."; //deprecated type
$lang['mediatype_tv'] = "tv : Intended for television-type devices."; //deprecated type
...
$lang['msg_completed'] = 'Operation completed';
...
$lang['msg_permstab'] = "Authorized administrators and the page owner can adjust the ownership and additional editors of a content page";
...
$lang['myprefsdescription'] = "This is where you can customize the site Admin Console to work the way you want.";

## N
$lang['n_a'] = 'N/A'; // abbreviated Not Applicable
$lang['name'] = "Name";
...
$lang['no_files_scanned'] = "No file was scanned during the verification process (maybe the file is invalid)";
...
$lang['no_shortcuts'] = "No shortcut defined yet. You can add them by clicking the link above.";
...
$lang['notices_timeout'] = 'Maximum Duration of Admin Console Popup Notifications <em>(seconds)</em>';
$lang['notices_timeout_short'] = 'Notifications Duration'; // popup help title
...
$lang['pages'] = "Pages";
$lang['pagesdescription'] = "This is where users can add and edit pages and other website content.";
...
$lang['permissions'] = "Permissions"; //see also 'zz_4perms_tab__'
...
$lang['perm_Clear_Admin_Log'] = 'Clear Admin Log'; // see also 'clearadminlog'
...
$lang['perm_Manage_Jobs'] = 'Manage Asynchronous Jobs'; //TODO migrate CmsJobManager
...
$lang['protected_data_path'] = 'Protected Data Path';
...
$lang['root'] = "Root";
$lang['routesrebuilt'] = "The database routes have been rebuilt";
$lang['run'] = "Run";
$lang['runuserplugin'] = "Save then execute this User Defined Tag";
...
$lang['show_shortcuts_message'] = "To show your shortcuts in your Admin theme bookmarks popup, set My account >> User Preferences >> Administration Shortcuts";
...
//$lang['sysmain_confirmupdateurls'] = "Are you sure you want to refresh the routes database?";
...
$lang['sysmain_nocontenterrors'] = "No content error detected";
$lang['sysmain_nostr_errors'] = "No structural error detected in the database";
...
$lang['sysmain_tablesfound'] = "tables found (of which %d are not sequence-tables)";
...
//$lang['templatesdescription'] = "This is where users can add and edit templates. Templates define the look and feel of this site.";
...
//$lang['test_curl'] = "Test for curl availability"; see 'curl'
//$lang['test_curlversion'] = "Test curl version"; see 'curlversion'
...
$lang['test_smarty_cacheudt'] = "Caching user defined tags can have serious performance benefits. Use caution"; //TODO silly overall message
$lang['test_smarty_caching'] = "Enabling Smarty caching can have serious performance benefits for most websites.";
$lang['test_smarty_compiled'] = 'Template-compilation checking can degrade performance, but ensures that any template change will automatically be processed, without pages-cache clearance or timeout';
...
$lang['warn_protected_path'] = "<strong>WARNING</strong> An inappropriate value for this property will cripple this website, correctable only by forensic manipulation by a site developer.<br>Change the value only if you're <strong>supremely</strong> confident that the result will be effective.";
...
$lang['help_content_thumbnail'] = "This field allows associating a thumbnail image with the content page.  Such image might be for display on the page, or used when building a navigation, etc.  Enter or select an absolute url, or a site-root-relative url, or just a file basename which will be taken to indicate the file is located in or below the site's configured uploaded-images folder.  See also the 'content_thumbnailfield_path' site-preference.";
