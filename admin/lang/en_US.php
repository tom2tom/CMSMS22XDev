...
$lang['info_changegroupperms'] = "This page allows specifying the permission(s) granted to Admin user groups.  Keep in mind that each Admin user can belong to multiple Admin groups.<br><strong>Note:</strong> the &quot;Admin&quot; group is a special group, the members of which are granted <strong><em>all permissions</em></strong>.";
$lang['info_changeusergroup'] = "This page allows specifying the user group(s) to which each Admin user belongs.  Group membership determines the permissions the user has, and therefore her/his capabilities in the Admin Console.<br><strong>Note:</strong> the &quot;Admin&quot; group is a special group, the members of which are granted <strong><em>all permissions</em></strong>.";
