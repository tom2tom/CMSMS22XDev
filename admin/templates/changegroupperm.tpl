...
{/if}
  ...
  <div class="pageoptions endalign" style="position:relative;z-index:20">
...
{/foreach}
  ...
  <form id="groupname" action="changegroupperm.php" method="post" style="display:inline-block;margin-top:-3em;width:100%">
    <div class="hidden">
      <input type="hidden" name="{$securename}" value="{$secureval}">
      <input type="hidden" name="sel_groups" value="{$hiddenval2}">
