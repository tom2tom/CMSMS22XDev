...
<div id="admin-alerts" class="notification" role="alert">
	...
	{if count($items)}
		<a href="#" class="open" title="{lang('notifications')}"><span>{$cnt=$items|@count}{if $items|@count > 1}{lang('notifications_to_handle',$cnt)}{else}{lang('notification_to_handle',$cnt)}{/if}</span></a>
