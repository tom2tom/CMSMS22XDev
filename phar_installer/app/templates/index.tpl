    ...
    <body class="cmsms-ui">
        ...
        <footer class="row footer-section">
            <div class="footer-info">
                <a href="https://forum.cmsmadesimple.org" target="_blank">{tr('title_forum')}</a> &bull; <a href="https://docs.cmsmadesimple.org" target="_blank">{tr('title_docs')}</a> &bull; <a href="https://apidoc.cmsmadesimple.org" target="_blank">{tr('title_api_docs')}</a>
            </div>
            <small>
