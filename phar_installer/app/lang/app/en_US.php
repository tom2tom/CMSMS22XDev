...
$lang['error_delete'] = 'Permissions problem: cannot delete %s';
...
//UNUSED see 'error_overwrite' $lang['error_filenotwritable'] = 'The file %s could not be overwritten (permissions problem)';
...
//$lang['error_nodbname'] = 'Please enter the name of a database on the host specified above';
//$lang['error_nodbpass'] = 'Please enter a valid password for authenticating access to the database';
//$lang['error_nodbprefix'] = 'Please enter a prefix for database tables';
...
$lang['finished_freshen_msg'] = 'The site\'s installation has been freshened! The core files have been updated, and any property-change(s) have been applied. You can now <a href="%s">visit the website</a> or log in to its <a href="%s">CMSMS Admin Console</a>.';
...
$lang['step2_errortoonew'] = 'The selected directory appears to contain a CMSMS installation with a newer version than is included in this assistant. Unable to proceed';
...
$lang['step9_news'] = 'Click here to find out about newsletters';
...
$lang['step9_support_us'] = 'Click here to find out how you can support CMSMS';
$lang['symbol'] = 'Symbol';
...
$lang['th_value'] = 'Value';
$lang['title_api_docs'] = 'API Documentation';
...
$lang['welcome_message'] = 'Using this assistant, you can quickly and easily confirm that your web host is compatible with CMSMS, and install or upgrade to the latest version of CMSMS, or refresh the files in the current CMSMS installation.';
