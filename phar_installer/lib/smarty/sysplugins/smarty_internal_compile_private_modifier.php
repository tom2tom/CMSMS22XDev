                ...
                switch ($type) {
                    case 1:
                        ...
                        if (isset($compiler->smarty->registered_plugins[ Smarty::PLUGIN_MODIFIER ][ $modifier ])) {
                            if (is_callable($compiler->smarty->registered_plugins[ Smarty::PLUGIN_MODIFIER ][ $modifier ][ 0 ])) {
                                $output =
                                    sprintf(
                                        'call_user_func_array($_smarty_tpl->smarty->registered_plugins[ \'%s\' ][ %s ][ 0 ], array( %s ))',
                    ...
                    case 3:
                        ...
                        if ($compiler->smarty->loadPlugin('smarty_modifiercompiler_' . $modifier)) {
                            ...
                            if (!is_object($compiler->smarty->security_policy)
                                ...
                                || !empty($compiler->smarty->registered_plugins[Smarty::PLUGIN_MODIFIERCOMPILER][$modifier][0]) //[0] = callable
                            ) {
                    ...
                    case 4:
                        ...
                        if ($function = $compiler->getPlugin($modifier, Smarty::PLUGIN_MODIFIER)) {
                            ...
                            if (!is_object($compiler->smarty->security_policy)
                                || $compiler->smarty->security_policy->isTrustedModifier($modifier, $compiler)
                                || !empty($compiler->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER][$modifier][0]) //[0] = callable
                            ) {
                    ...
                    case 5:
                        ...
                        if (is_callable($modifier)) {
                            ...
                            if (!is_object($compiler->smarty->security_policy)
                                ...
                                || !empty($compiler->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION][$modifier][0]) //[0] = callable
                            ) {
